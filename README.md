...
- A [Google Gemini API Key](https://aistudio.google.com/apikey) — free with any Google account
...
- `n8n-builder-system-prompt.md` — 693 lines, ~85% coverage
- `n8n-builder-system-prompt-extended.md` — 966 lines, ~95% coverage
